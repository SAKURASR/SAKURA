...
sudo_users = {SUDO,1696477971,1052745572,833156404}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝒔𝒐𝒓𝒖𝒄𝒆 𝒔𝒂𝒌𝒖𝒓𝒂")  
...
if text == 'جلب نسخه ⋄' and DevToFy(msg) then 
GetFile_Bot(msg)
end
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevToFy(msg) then
...
if text == 'رفع نسخه' and DevToFy(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
{{text = '🖨┇𝒔𝒐𝒓𝒖𝒄𝒆 𝒔𝒂𝒌𝒖𝒓𝒂',url="t.me/SAKURAV15"}},
}
...
database:set(bot_id.."SAKURAV15:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SAKURAV15:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SAKURAV15:insta_bot"..msg.chat_id_) == "open" then
...
end --الكود حصري سورس ساكورا يعني لو بكتهن راح اعرفك انت الاخذتهن
...
local ToFy = '⋄︙عدد الادمنيه : '..data.administrator_count_..
...
if text == 'استعاده الاوامر' and DevToFy(msg) then
...
{
{text = '𝑺𝑨𝑲𝑼𝑹𝑨 𝑪𝑯𝑨𝑵𝑵𝑬𝑳', url="t.me/SAKURAV15"},
},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.." ToFy:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزغرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⋄︙ تم تفعيل الزغرفه')
database:set(bot_id.." ToFy:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." ToFy:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." ToFy:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⋄︙ تم تفعيل الابراج')
database:set(bot_id.." ToFy:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." ToFy:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." ToFy:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '⋄︙ تم تعطيل حساب العمر')
database:set(bot_id.." ToFy:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." ToFy:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." ToFy:age_Bots"..msg.chat_id_) == "open" then
...
if text and text:match("^فلم (.*)$") and database:get(bot_id.."ToFy:movie_bot"..msg.chat_id_) == "open" then
...
if text == "@MMLMMM" or text == "توفي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
